...
const PostAppliedFilters = ({ filteredPostsCount }) => {
        ...
        <div className="product-list-header-title">
          <h5>
            {filteredPostsCount > 0
              && `Found ${filteredPostsCount} ${filteredPostsCount > 1 ? 'posts' : 'post'}`}
          </h5>
        </div>
      </div>
...
PostAppliedFilters.defaultProps = {
  filteredPostsCount: 0
};

PostAppliedFilters.propTypes = {
  filteredPostsCount: PropType.number
};

export default PostAppliedFilters;
